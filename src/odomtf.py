...
class CamBotOdomToTF(Node):
    ...
    def __init__(self, robot_name="rick"):
        node_name = robot_name+"tf_broadcaster_node"
        super().__init__(node_name)

        self._robot_base_frame = robot_name + "/base_link"
...
def main(args=None):
    ...
    rclpy.init()
    rick_odom_to_tf_obj = CamBotOdomToTF("rick")
    morty_odom_to_tf_obj = CamBotOdomToTF("morty")
    rclpy.spin(morty_odom_to_tf_obj)
    rclpy.spin(rick_odom_to_tf_obj)
